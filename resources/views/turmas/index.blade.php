                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Turmas Registradas')}}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ redirect()->back()->getTargetUrl() }}" class="btn btn-sm btn-primary">{{ __('Menu Principal') }}</a>
                                <a href="{{ route('turma.create') }}" class="btn btn-sm btn-primary">{{ __('Registrar turma') }}</a>
                            </div>
                        </div>
                    </div>
