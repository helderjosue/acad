...
@section('content')
    @include('users.partials.header', ['title' => __('Registro de disciplina')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Dados do Registro') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('disciplina.store') }}" autocomplete="off" id="form" enctype="multipart/form-data">
                            @csrf
                                                ...
                                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                                    <div class="row">
                                                        <div class="col-md">
                                                            ...
                                                            <div id="div-input-election_title">
                                                                <input type="text" name="NOMEDISCIPLINA" id="input-nome" class="form-control" placeholder="{{ __('Digite o nome') }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md">
                                                            ...
                                                            <div id="div-input-election_title">
                                                                <select class="form-control" name="CDPROFESSOR" required>
                                                                    ...
                                                                    <option value="{{$professor->CDPROFESSOR}}">
                                                                        {{$professor->NOME}}
                                                                    </option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div id="div-input-election_title">
                                                                <input type="number" name="VALOR" id="input-nome" class="form-control" placeholder="{{ __('Digite o valor') }}" min="0" step="0.01">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
