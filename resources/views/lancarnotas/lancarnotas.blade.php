        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <form method="post" action="{{ route('lancarnotas.store') }}" autocomplete="off" id="form" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="row" style="padding-left: 1.6em; margin-bottom: 1em">
                            <div class="col-md-3">
                                ...
                                <input id="nameAvali" type="text" class="form-control" name="REFERENCIA" placeholder="Ex: Prova 1" onblur="javascript:checkNomeAvaliacao();" required min="3" maxlength="10">
                            </div>
                        </div>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="width: 2em; text-align: center;" >{{ __('Nota') }}</th>
                                   ...
                                   @foreach($alunos as $key => $aluno)
                                        <tr>
                                            ...
                                            <td style="border-left: 1px solid #e9ecef; text-align: center;">
                                                <input style="width: 8em; height: 3em" class="form-control inputNota" type="number" name="NOTA[{{$aluno->CDMATDISCIPLINA}}][]" min="0" max="20" step="0.1" required>
                                            </td>
