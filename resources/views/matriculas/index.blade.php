                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Matriculas Registradas')}}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('secretaria') }}" class="btn btn-sm btn-primary">{{ __('Menu Principal') }}</a>
                                <a href="{{ route('matricula.create') }}" class="btn btn-sm btn-primary">{{ __('Registrar matricula') }}</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($matriculas as $key => $matricula)
                                    ...
                                    <tr>
                                        ...
                                        <td>MZN {{ number_format($matricula->VALOR, 2) }}</td>
                                        <td class="text-right">
                                            <div class="dropdown">
